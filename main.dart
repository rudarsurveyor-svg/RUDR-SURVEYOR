...
class _RudrSurveyorAppState extends State<RudrSurveyorApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        '/measurement': (_) => LandMeasurementScreen(isGujarati: gu),
        '/area': (_) => AreaCalculatorScreen(isGujarati: gu),
        '/units': (_) => UnitConverterScreen(isGujarati: gu),
        '/knowledge': (_) => KnowledgeScreen(isGujarati: gu),
        '/report': (_) => SurveyReportScreen(isGujarati: gu),
      },
    );
  }
}
